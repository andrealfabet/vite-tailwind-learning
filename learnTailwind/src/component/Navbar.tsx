...
function Navbar() {
    ...
    return (
        <nav
            className={`sticky top-0 left-0 w-full bg-amber-50/80 dark:bg-black/80 backdrop-blur-md border-b border-stone-200 dark:border-white/10 z-50 transition-all duration-300 ${scrolled ? "py-3" : "py-4"
                }`}
        >
