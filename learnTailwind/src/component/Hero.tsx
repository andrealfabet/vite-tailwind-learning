...
function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen bg-black flex items-center px-8 md:px-16 py-24"
    >
      <div className="max-w-7xl w-full mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-6">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight">
            Hi, I'm{" "}
            <span className="text-teal-400">Fajar</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <a
              href="#contact"
              className="px-6 py-3 border border-white/20 hover:border-teal-500/50 text-white rounded-lg transition-all duration-300 hover:bg-white/5"
            >
              Contact Me
            </a>
          </div>
