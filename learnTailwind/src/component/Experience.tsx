...
function Experience() {
  return (
    <section id="experience" className="py-24 bg-black px-8 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          {experiences.map((exp, i) => (
            <div
              key={i}
              className="bg-gray-950 rounded-2xl p-8 border border-white/10 hover:border-teal-500/30 hover:shadow-xl hover:shadow-teal-500/5 transition-all duration-300"
            >
              {/* Header row */}
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-4">
                ...
                <span className="self-start text-sm text-gray-500 bg-white/5 border border-white/10 px-4 py-1.5 rounded-full whitespace-nowrap">
                  {exp.period}
                </span>
              </div>
